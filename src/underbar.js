...
(function() {
  ...
  _.last = function(array, n) {
    var arrLenth = array.length;
    if (n > arrLenth) {
      return array;
    } else {
      return n === undefined ? array[arrLenth-1] : array.slice(arrLenth-n, arrLenth);
    }
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(array, function(value, index, list) {
        randomize = Math.floor(Math.random() * (index + 1));
        shuffled[index] = shuffled[randomize];
        shuffled[randomize] = value;
    });
    return shuffled;
  };
